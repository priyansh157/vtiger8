...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		<div class="app-list row">
			...
			{/foreach}
			<div class="dropdown app-modules-dropdown-container">
				<div class="menu-item app-item dropdown-toggle app-item-color-CONTACTS" data-app-name="CONTACTS" id="PROJECT_modules_dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-default-url="index.php?module=Contacts&view=List">
					<div class="menu-items-wrapper app-menu-items-wrapper">
						<span class="app-icon-list fa fa-user"></span>
						<span class="app-name textOverflowEllipsis">CONTACTS</span>
					</div>
				</div>
			</div>
			<div class="dropdown app-modules-dropdown-container">
				<div class="menu-item app-item dropdown-toggle app-item-color-ORGANIZATIONS" data-app-name="ORGANIZATIONS" id="PROJECT_modules_dropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-default-url="index.php?module=Accounts&view=List">
					<div class="menu-items-wrapper app-menu-items-wrapper">
						<span class="app-icon-list fa fa-building"></span>
						<span class="app-name textOverflowEllipsis">ORGANIZATIONS</span>
					</div>
				</div>
			</div>
