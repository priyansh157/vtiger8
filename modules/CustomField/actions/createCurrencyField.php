...
class CustomField_createCurrencyField_Action extends Vtiger_Action_Controller {
	...
	public function process(Vtiger_Request $request) {
		...
		$fieldInstance->columntype = 'DECIMAL('.$fieldLength.',2)';
		$fieldInstance->uitype = $uiType;
		if($isMandatory=="Yes"){
			$fieldInstance->typeofdata = 'N~M';
		}else{
