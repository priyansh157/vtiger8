...
class CustomField_createDecimalField_Action extends Vtiger_Action_Controller {
	...
	public function process(Vtiger_Request $request) {
		...
		$fieldInstance->columntype = 'DECIMAL('.$fieldLength.','.$decimal.')';
		$fieldInstance->uitype = $uiType;
		if($isMandatory=="Yes"){
			$fieldInstance->typeofdata = 'NN~M';
		}else{
